...
class GatewayRepository {
  ...
  Future<List<BackendGateway>> fetchUserGateways() async {
    ...
    return list
        .map((e) => BackendGateway.fromJson(e as Map<String, dynamic>))
        .toList();
  }
  ...
  Future<BackendGateway> createGateway(Map<String, dynamic> data) async {
    ...
    final gatewayData =
        responseData['gateway'] as Map<String, dynamic>? ?? responseData;
    return BackendGateway.fromJson(gatewayData);
  }

  Future<BackendGateway> updateGateway(
    String gatewayId,
    Map<String, dynamic> data,
  ) async {
    final response = await _apiClient.patch(
      ApiConfig.updateGateway(gatewayId),
      data: data,
    );
    final responseData = response.data as Map<String, dynamic>;
    final gatewayData =
  ...
  Future<void> updateGatewaySerialNumber(
    String gatewayId,
    String serialNumber,
  ) async {
    await updateGateway(gatewayId, {'serialNumber': serialNumber});
  }
  ...
  Future<void> addCitizen(
    ...
    await _apiClient.post(
      ApiConfig.gatewayCitizens(gatewayId),
      data: citizenData,
    );
  }
